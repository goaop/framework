 ...
 *
 * The AspectKernel is a per-process singleton, so the happy path (a real warmup)
 * is covered by the functional CacheWarmupCommandTest which shells out. These
 * tests cover everything that is safe to run inside the PHPUnit process:
 * attribute-based metadata, input validation and signal handling.
 */
