...
{
    use TestAttributeArgsClassOriginal {
        TestAttributeArgsClassOriginal::tagged as private taggedOriginal;
        TestAttributeArgsClassOriginal::collected as private collectedOriginal;
    }
