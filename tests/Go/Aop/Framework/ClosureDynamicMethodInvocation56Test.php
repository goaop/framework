 ...
 */
class ClosureDynamicMethodInvocation56Test extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDynamicMethodInvocation($methodName, $expectedResult)
    {
        ...
        $invocation = new ClosureDynamicMethodInvocation56(self::FIRST_CLASS_NAME, $methodName, array());
    ...
    {
        $child      = $this->getMock(self::FIRST_CLASS_NAME, array('none'));
        $invocation = new ClosureDynamicMethodInvocation56(self::FIRST_CLASS_NAME, 'passByReference', array());
    ...
    {
        $child      = $this->getMock(self::FIRST_CLASS_NAME, array('none'));
        $invocation = new ClosureDynamicMethodInvocation56(self::FIRST_CLASS_NAME, 'variableArgsTest', array());
    ...
    public function testRecursionWorks()
    {
        ...
        $invocation = new ClosureDynamicMethodInvocation56(self::FIRST_CLASS_NAME, 'recursion', array());
    ...
    public function testInterceptorIsCalledForInvocation()
    {
        ...
        $invocation = new ClosureDynamicMethodInvocation56(self::FIRST_CLASS_NAME, 'publicMethod', array($advice));
