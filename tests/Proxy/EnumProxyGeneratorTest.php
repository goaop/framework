...
class EnumProxyGeneratorTest extends TestCase
{
    ...
    public function testGenerateProxyEnumMethod(): void
    {
        ...
        $traitName       = 'Go\\Stubs\\StubBackedEnumOriginalTrait';
        $classAdvices    = [
            'method' => [
        ...
        $this->assertStringContainsString('StubBackedEnumOriginalTrait', $output);
        $this->assertStringContainsString('labelOriginalAlias', $output);
    ...
    public function testGenerateProxyEnumWithStaticMethod(): void
    {
        ...
        $this->assertStringContainsString('fromLabelOriginalAlias', $output);
    ...
    public function testGeneratePreservesEnumCases(): void
    {
        ...
        $generator = new EnumProxyGenerator($reflectionClass, 'Go\\Stubs\\StubBackedEnumOriginalTrait', $classAdvices);
        $output    = "<?php\n" . $generator->generate();
    ...
    public function testGeneratePreservesConstantExpressionCaseValues(): void
    {
        ...
        $generator = new EnumProxyGenerator(
            $reflectionClass,
            'Go\\Stubs\\StubConstExprBackedEnumOriginalTrait',
            $classAdvices,
        );
        $output = "<?php\n" . $generator->generate();
    ...
    public function testGenerateDoesNotIncludeBuiltinEnumInterfaces(): void
    {
        ...
        // also a substring of the stub class name 'StubBackedEnumOriginalTrait'.
    ...
    public function testTraitAdoptionUsesShortNameWhenSameNamespace(): void
    {
        ...
        $traitFqcn = 'Go\\Stubs\\StubBackedEnumOriginalTrait';
        $generator = new EnumProxyGenerator($reflectionClass, $traitFqcn, $classAdvices);
        $output    = "<?php\n" . $generator->generate();

        // Must use the short (unqualified) trait name
        $this->assertStringContainsString('use StubBackedEnumOriginalTrait {', $output);
        $this->assertStringContainsString('StubBackedEnumOriginalTrait::label as private labelOriginalAlias', $output);
        $this->assertStringNotContainsString('\\Go\\Stubs\\StubBackedEnumOriginalTrait', $output);
    }
    ...
    public function testTraitAdoptionUsesFqcnWhenDifferentNamespace(): void
    {
        ...
        $traitFqcn = 'Other\\Namespace\\StubBackedEnumOriginalTrait';
        $generator = new EnumProxyGenerator($reflectionClass, $traitFqcn, $classAdvices);
        $output    = "<?php\n" . $generator->generate();

        // Must use the FQCN for the trait name
        $this->assertStringContainsString('use \\Other\\Namespace\\StubBackedEnumOriginalTrait {', $output);
        $this->assertStringContainsString('\\Other\\Namespace\\StubBackedEnumOriginalTrait::label as private labelOriginalAlias', $output);
        $this->assertStringNotContainsString('use StubBackedEnumOriginalTrait {', $output);
    }
    ...
    public function testGenerateFiltersOutBuiltinEnumMethods(): void
    {
        ...
        $this->assertStringContainsString('labelOriginalAlias', $output);
        $this->assertStringNotContainsString('casesOriginalAlias', $output);
        $this->assertStringNotContainsString('fromOriginalAlias', $output);
        $this->assertStringNotContainsString('tryFromOriginalAlias', $output);
    }
