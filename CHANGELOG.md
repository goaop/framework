...
* [Feature] Supports both `goaop/parser-reflection` 4.x and 5.x (`^4.0 || ^5.0`); 5.x requires PHP 8.5+ and brings PHP 8.6 syntax support (partial function application, readonly property defaults, parameter doc comments).
