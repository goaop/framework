...
class WeavingTransformer extends BaseSourceTransformer
{
     ...
     *  - Renames the class to $newClassName (Original suffix)
    ...
    private function convertClassToTrait(
        ...
        // PHP copies attributes to alias names (e.g. fooOriginal). Since fooOriginal has no parent
     ...
     *  - Renames the enum to $newClassName (Original suffix)
    ...
    private function convertEnumToTrait(
        ...
        // PHP copies attributes to alias names (e.g. labelOriginal), and since labelOriginal has
     ...
     * `SomeTrait::method as private methodOriginal`), PHP copies the method's attributes to
