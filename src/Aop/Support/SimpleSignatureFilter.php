...
/**
 * Simple signature matcher that match class|method|property by it's name
 *
 * Element name can contain wildcards '*', '**', '|' and '?'
 */
class SimpleSignatureFilter implements PointFilter
{
